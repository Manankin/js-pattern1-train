...
class HoneyDecorator {
  ...
  get name() {
    return  `${this.drink.name} з ${this.smount}г меду`
    }  
  ...
  // Метод prepare відповідає за приготування напою з медом. Він виводить в консоль Приготування ${this.name} з медом
  prepare() {
    console.log(`Приготування ${this.drink.name} з ${this.amount}г меду`)
  }
}
